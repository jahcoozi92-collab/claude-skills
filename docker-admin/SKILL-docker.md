---
name: docker-admin
description: Hilft bei Docker-Container-Management auf Diana's NAS und lokalen Systemen. Optimiert für UGREEN DXP4800PLUS, Portainer und Docker Compose. Trigger bei Docker, Container, Compose, Portainer, Image.
---
